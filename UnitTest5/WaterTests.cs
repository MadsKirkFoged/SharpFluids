...
public class WaterLookups
{
    ...
    public void UpdatePX()
    {
        ...
        Assert.AreEqual(133.522420460943, Water.Temperature.DegreeCelsius, 0.0001);
        Assert.AreEqual(133.52242046094256, Water.Tsat.DegreeCelsius, 0.0001);
        Assert.AreEqual(373.946, Water.CriticalTemperature.DegreeCelsius, 0.0001);
        Assert.AreEqual(1726.85, Water.LimitTemperatureMax.DegreeCelsius, 0.0001);
        Assert.AreEqual(0.010000000000047749, Water.LimitTemperatureMin.DegreeCelsius, 0.0001);
    ...
    public void UpdatePT()
    {
        ...
        Assert.AreEqual(237, Water.Temperature.DegreeCelsius, 0.0001);
        Assert.AreEqual(133.522420460943, Water.Tsat.DegreeCelsius, 0.0001);
        Assert.AreEqual(373.946, Water.CriticalTemperature.DegreeCelsius, 0.0001);
        Assert.AreEqual(1726.85, Water.LimitTemperatureMax.DegreeCelsius, 0.0001);
        Assert.AreEqual(0.010000000000047749, Water.LimitTemperatureMin.DegreeCelsius, 0.0001);
    ...
    private static bool AreAproximativellyEqual(double expected, double actual, double abs_err) => Math.Abs(expected - actual) <= abs_err;
    ...
    public class ICompWater
    {
        ...
        public void UpdatePT()
        {
            ...
            Assert.AreEqual(30, Water.Temperature.DegreeCelsius, 0.0001);
            Assert.AreEqual(30, Water.Tsat.DegreeCelsius, 0.0001);
            Assert.IsNull(Water.CriticalTemperature);
            Assert.AreEqual(200, Water.LimitTemperatureMax.DegreeCelsius, 0.0001);
            Assert.AreEqual(0, Water.LimitTemperatureMin.DegreeCelsius, 0.0001);
